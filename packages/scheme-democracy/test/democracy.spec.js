    ...
    context('#initialize', () => {
        context('parameters are in bound', () => {
            it('it should initialize scheme', async () => {
                ...
                assert.equal(quorum, parameters.quorum*Math.pow(10, 16))
                assert.equal(required, parameters.required*Math.pow(10, 16))
            })
    ...
    context('Requests For Individuation | RFI', () => {
        context('#create', () => {
            ...
            it('it should initialize RFI vote', async () => {
                ...
                assert.equal(vote.quorum, parameters.quorum*Math.pow(10, 16))
                assert.equal(vote.required, parameters.required*Math.pow(10, 16))
            ...
            it('it should initialize related RFL votes', async () => {
                ...
                assert.equal(vote_1.quorum, parameters.quorum*Math.pow(10, 16))
                assert.equal(vote_1.required, parameters.required*Math.pow(10, 16))
                ...
                assert.equal(vote_2.quorum, parameters.quorum*Math.pow(10, 16))
                assert.equal(vote_2.required, parameters.required*Math.pow(10, 16))
