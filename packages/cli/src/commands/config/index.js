...
var config = __importStar(require("@lib/config"));
...
var handler = function (argv) { return __awaiter(_this, void 0, void 0, function () {
    var configuration, configuration, pando, repository, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 7, , 8]);
                if (!argv.global) return [3 /*break*/, 2];
                return [4 /*yield*/, inquirer_1.default.configure()];
            case 1:
                configuration = _a.sent();
                config.save(configuration);
                return [3 /*break*/, 6];
            case 2: return [4 /*yield*/, inquirer_1.default.configure()];
            case 3:
                configuration = _a.sent();
                return [4 /*yield*/, pando_js_1.default.create(configuration)];
            case 4:
                pando = _a.sent();
