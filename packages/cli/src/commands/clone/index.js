...
var handler = function (argv) { return __awaiter(_this, void 0, void 0, function () {
    var pando, repository, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 5, , 6]);
                if (!!config.exists()) return [3 /*break*/, 1];
                display.error('pando not configured yet');
                display.error('run pando config --global');
                return [3 /*break*/, 4];
            case 1: return [4 /*yield*/, pando_js_1.default.create(config.load())];
            case 2:
                pando = _a.sent();
                return [4 /*yield*/, pando.repositories.clone(argv.address)];
            case 3:
                repository = _a.sent();
