...
var handler = function (argv) { return __awaiter(_this, void 0, void 0, function () {
    var pando, repository, remote, infos, components, branches, branch, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                repository = _a.sent();
                return [4 /*yield*/, repository.remotes.load(argv.name)];
            case 3:
                remote = _a.sent();
                return [4 /*yield*/, remote.show()];
            case 4:
                infos = _a.sent();
                components = new cli_table_1.default({
                    head: ['Component', 'Address'],
                    colWidths: [50, 50]
                });
                branches = new cli_table_1.default({
                    head: ['Branch', 'Head'],
                    colWidths: [50, 50]
                });
