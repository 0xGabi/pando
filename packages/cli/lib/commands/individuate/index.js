...
var handler = function (argv) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 4, , 5]);
                spinner = ora_1.default(chalk_1.default.dim("Pushing individuation to " + argv.organism)).start();
            ...
            case 2:
                ...
                return [4 /*yield*/, plant.publish(organizationName, organismName, argv.message)];
            case 3:
                _b.sent();
                spinner.succeed(chalk_1.default.dim("Individuation pushed to " + argv.organism));
                return [3 /*break*/, 5];
            case 4:
                err_1 = _b.sent();
